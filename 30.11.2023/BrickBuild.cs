...
{
    internal class BrickBuild : IBuilding
    {
        private uint id;
        private uint high;
        private uint level;
        ...
        public BrickBuild(uint id, uint high, uint level, uint numberOfApartament, uint entrance)
        {
            this.id = id;
            this.high = high;
            this.level = level;
            ...
            this.description = "Кирпичное здание";
        }
